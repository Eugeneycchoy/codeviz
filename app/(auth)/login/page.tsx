    ...
    <div className="flex flex-col items-center justify-center min-h-[calc(100vh-64px)] px-6 py-20">
      <div className="w-full max-w-md bg-white p-12 rounded-[40px] border border-slate-100 shadow-2xl shadow-slate-100/50 space-y-10 text-center relative overflow-hidden">
        ...
        <div className="space-y-4">
          <button
            type="button"
            className="w-full h-14 flex items-center justify-center gap-4 bg-[#24292F] text-white rounded-2xl font-bold transition-all hover:bg-[#1a1e22] hover:shadow-lg hover:shadow-[#24292F]/20 active:scale-[0.98]"
          >
          ...
          <button
            type="button"
            className="w-full h-14 flex items-center justify-center gap-4 border-2 border-slate-100 bg-white text-slate-700 rounded-2xl font-bold transition-all hover:border-slate-200 hover:bg-slate-50 hover:shadow-lg hover:shadow-slate-100 active:scale-[0.98]"
          >
